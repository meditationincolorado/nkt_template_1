		...
		<footer class="row">
			<section class="col-xs-12 col-sm-10 col-sm-offset-1">
				<ul class="col-xs-12 col-sm-3">
					...
					<li><a href="" target="_blank">Free EBook: Modern Buddhism</a></li>
					<li>&nbsp;</li>
